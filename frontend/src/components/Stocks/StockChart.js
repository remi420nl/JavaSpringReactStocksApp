...
//Sotckchart from reac-stocharts, customized so it fits this apps using the converted json data
let StockChart = class StockChart extends React.Component {
  render() {
    const ema20 = ema()
      .id(0)
    ...
    const { type, stockdata, ratio } = this.props;
    const calculatedData = ema20(ema50(smaVolume70(stockdata)));
